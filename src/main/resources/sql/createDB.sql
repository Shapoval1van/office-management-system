...
ALTER TABLE CHANGE_ITEM
  DROP CONSTRAINT FIELD_FK;
ALTER TABLE REQUEST
  DROP CONSTRAINT GROUP_FK;
ALTER TABLE REQUEST
  DROP CONSTRAINT MANAGER_FK;
ALTER TABLE CHANGE_GROUP
  DROP CONSTRAINT REQUEST_FK;
ALTER TABLE PERSON
  DROP CONSTRAINT ROLE_FK;
ALTER TABLE REQUEST
  DROP CONSTRAINT STATUS_FK;
ALTER TABLE CHANGE_ITEM
  DROP CONSTRAINT group_fkv2;
ALTER TABLE REQUEST
  DROP CONSTRAINT parent_request_fk;
ALTER TABLE REQUEST
  DROP CONSTRAINT priority_FK;

DROP TABLE CHANGE_GROUP;
