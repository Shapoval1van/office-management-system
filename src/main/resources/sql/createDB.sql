...
ALTER TABLE IF EXISTS VERIFICATION_TOKEN DROP CONSTRAINT PERSON_FK;
ALTER TABLE IF EXISTS PASS_RESET_TOKEN DROP CONSTRAINT PASS_RESET_TOKEN_PERSON_FK;
...
DROP TABLE IF EXISTS PASS_RESET_TOKEN;
